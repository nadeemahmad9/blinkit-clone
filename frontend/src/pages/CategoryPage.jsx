                ...
                <div className="w-24 md:w-32 bg-white border-r border-gray-200 overflow-y-auto flex-none pb-20 no-scrollbar">
                    {currentCategory.subCategories.map((sub) => (
                        ...
                        >
                            ...
                            <div className={`w-12 h-15 rounded-2xl flex items-center justify-center p-1 border transition-all ${activeSub === sub.id ? "bg-white border-[#318616] scale-105" : "bg-gray-50 border-gray-100"}`}>
