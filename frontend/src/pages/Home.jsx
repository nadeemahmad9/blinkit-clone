    ...
    return (
        ...
        <div className="min-h-screen pb-24 font-sans max-w-[1280px] mx-auto bg-white">
            ...
            <div className="p-4">
                ...
                <Link to="/products" className=" w-full h-auto rounded-2xl overflow-hidden relative shadow-sm cursor-pointer transition-transform hover:scale-[1.01] duration-200">
                    <img
